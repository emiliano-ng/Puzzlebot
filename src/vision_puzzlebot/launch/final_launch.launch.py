...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package='vision_puzzlebot_trt',
            executable='sign_detect_trt',
            name='vision_YOLO',
            output='screen',
            parameters=[
                params_file,
                {
                    ...
                    FindPackageShare('vision_puzzlebot_trt'),
                    'models',
                    'yolov4-tiny-signs_best_fp16.engine']),
                    'names_path': PathJoinSubstitution([
                    FindPackageShare('vision_puzzlebot_trt'),'models','obj.names']),
                    'input_topic': '/cam/img_raw',
                }],
        ),
